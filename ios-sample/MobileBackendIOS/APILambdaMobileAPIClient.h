 ...
 */
@interface APILambdaMobileAPIClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = APILambdaMobileAPIClient.defaultClient()

 *Objective-C*

     APILambdaMobileAPIClient *serviceClient = [APILambdaMobileAPIClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         APILambdaMobileAPIClient.registerClientWithConfiguration(configuration, forKey: "USWest2APILambdaMobileAPIClient")
 ...
 *Swift*
     ...
     let serviceClient = APILambdaMobileAPIClient(forKey: "USWest2APILambdaMobileAPIClient")

 *Objective-C*

     APILambdaMobileAPIClient *serviceClient = [APILambdaMobileAPIClient clientForKey:@"USWest2APILambdaMobileAPIClient"];
...
/**
 ...
 return type: APISearchNoteResponse *
 */
