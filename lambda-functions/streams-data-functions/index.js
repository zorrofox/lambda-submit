...
var cloudSearchDomain = new AWS.CloudSearchDomain({endpoint : 'doc-lambda-bak-uhjrog37cjiav2vv5ijgdriifi.ap-northeast-1.cloudsearch.amazonaws.com'});
        ...
        if (record.eventName === "INSERT") {
            var searchDocument = {
                ...
                fields : {
                    ...
                    s3key: record.dynamodb.NewImage.s3key.S
                }
            };
