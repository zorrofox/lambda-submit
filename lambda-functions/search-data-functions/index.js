...
var cloudSearchDomain = new AWS.CloudSearchDomain({endpoint : 'search-lambda-bak-uhjrog37cjiav2vv5ijgdriifi.ap-northeast-1.cloudsearch.amazonaws.com'});
...
function processSearchResults(data) { 
    ...
    for (var i=0; i < hits.length; i++) {
        ...
        searchResult.s3key = currentMatch.fields.s3key[0];
